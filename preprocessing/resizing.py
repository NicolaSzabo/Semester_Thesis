...
def process_images(directory, output_directory, target_shape):
    ...
    for filename in os.listdir(directory):
        if filename.endswith('.nii.gz'):
            ...
            # Check for NaN values in the padded data
            if np.any(np.isnan(padded_data)):
                print(f"NaN values detected in {filename} after padding.")
...
if __name__ == '__main__':
    ...
    directory = 'G://semester_thesis//Project//data//data_classification//healthy_final'
    output_directory = 'G://semester_thesis//Project//data//data_classification//healthy_final_processed'

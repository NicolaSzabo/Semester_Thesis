...
# Define the paths
full_body_path = "G://data//niftis_full_body"
masked_with_nan_path = "G://data//preprocessing//preprocessing/resized_without_aorta"
excel_file_path = "G://data//data_overview.xlsx"
...
data['masked_without_aorta'] = data['Nr'].apply(lambda x: 'yes' if x in masked_files else 'no')

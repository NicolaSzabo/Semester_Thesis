...
# Linux: f"/home/fit_member/Documents/NS_SemesterWork/Project/{model_filename}"
...
# Combine all images and classes into a single list
image_files_list = []
image_class = []
...
# for windows: rf"C:\Users\nicol\OneDrive\Desktop\Semester_Thesis\Project\runs\experiment_{datetime.now().strftime('%Y-%d-%m_%H-%M')}"
...
plot_metrics(epoch_loss_values, metric_values, val_interval, save_path = f"/home/fit_member/Documents/NS_SemesterWork/Project/results/graph_{datetime.now().strftime('%Y-%d-%m_%H-%M')}")
